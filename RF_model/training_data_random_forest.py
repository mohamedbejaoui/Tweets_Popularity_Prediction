...
"""
index_start, index_length, occurences = 3700, 20, 40
...
RF_train_data = pd.read_csv('training_data_RF.csv', names=['c','theta','A1','n_star','w','N_real','N_predict','Error_predict','n','start_ind'], header=0)
#RF_train_data = pd.DataFrame(columns=['c','theta','A1','n_star','w','N_real','N_predict','n','Error_predict'])
