...
"""
index_start, index_length, occurences = 260, 20, 15
...
RF_train_data = pd.read_csv('training_data_RF.csv', names=['c','theta','A1','n_star','w','N_real','N_predict','Error_predict'], header=0)
